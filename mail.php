<?php
/**
 * Obsługa formularza kontaktowego – sleever.com.pl
...
define('MAIL_FROM', 'biuro@spolex.com');
...
if ($produkt === '') {
    $errors[] = 'Opisz opakowanie, folię lub cel wdrożenia.';
}
...
$subject = 'Zapytanie z sleever.com.pl – ' . $firma;

$body  = "Nowe zapytanie ze strony sleever.com.pl\r\n\r\n";
$body .= "Imię i nazwisko: {$imie}\r\n";
$body .= "Firma: {$firma}\r\n";
$body .= "E-mail: {$email}\r\n";
$body .= "Telefon: " . ($telefon !== '' ? $telefon : '—') . "\r\n\r\n";
$body .= "Opakowanie / wydajność / wiadomość:\r\n{$produkt}\r\n\r\n";
$body .= "---\r\n";
